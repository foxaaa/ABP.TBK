...
namespace ABP.TBK.Web.Startup
{
    ...
    /// </summary>
    public class TBKNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                .AddItem(new MenuItemDefinition(
                    PageNames.Products,
                    new FixedLocalizableString("淘宝客列表"),
                    url: "Products",
                    icon: "local_offer"
        ...
        {
            return new LocalizableString(name, TBKConsts.LocalizationSourceName);
        }
    }
}
